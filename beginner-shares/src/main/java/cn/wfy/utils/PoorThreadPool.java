...
public class PoorThreadPool {
    ...
    private static Integer capacity = 30;//缓存队列长度，用的有界
    private static Integer corePoolSize = 4;//不会关闭的核心池，我的为0，这样不消化线程资源
    private static Integer maxiMumPoolSize = 9;//使用完会关闭的线程
    private static Long keepAliveTime = 100L;//100s后关闭alive
